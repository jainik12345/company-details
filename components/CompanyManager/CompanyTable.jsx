...
const CompanyTable = () => {
  ...
  const exportToExcel = () => {
    ...
    const exportData = filtered.map((company) => ({
      "No.": filtered.indexOf(company) + 1,
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <input
            ...
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="px-4 py-3 border rounded-lg w-full sm:w-80 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
          />
          ...
          <select
            value={selectedLocation}
            onChange={(e) => setSelectedLocation(e.target.value)}
            className="px-4 py-3 border rounded-lg w-full sm:w-48 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
          >
            <option value="">All Locations</option>
            {locations.map((loc) => (
              <option key={loc} value={loc}>
        ...
        <button
          ...
          className="px-6 py-3 bg-emerald-600 border hover:bg-emerald-700 disabled:bg-gray-400 text-white font-medium cursor-pointer flex items-center gap-2 shadow-sm transition-all duration-200 whitespace-nowrap"
        >
