...
const CompanyForm = ({ companyId = null }) => {
  ...
  const fetchCompanyData = async () => {
    try {
      ...
      else setError(json.error || "Failed to load company data");
    } catch {
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 md:grid-cols-2">
        ...
        <div className="md:col-span-2  flex flex-col sm:flex-row gap-4 pt-4">
          <button
            type="submit"
            disabled={submitting}
            className="flex-1 border-2 cursor-pointer bg-blue-600 text-white py-3 rounded-md text-sm font-semibold hover:bg-blue-700 transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {submitting ? (
              <>
          ...
          <button
            ...
            disabled={submitting}
            className="flex-1 border-2 cursor-pointer bg-gray-200 text-gray-800 py-3 rounded-md text-sm font-semibold hover:bg-gray-300 transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
            <X className="w-5 h-5" />
            Cancel
          </button>
